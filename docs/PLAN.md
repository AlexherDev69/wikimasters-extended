...
- Le son est fabriqué, pas téléchargé : deux sinusoïdes (A5 puis E6) dans un `AudioContext` ouvert une seule fois par page, 250 ms en tout, gain crête 0,12. Aucun fichier dans le paquet de l'extension, aucune adresse demandée, et aucune notification du navigateur ni du système
