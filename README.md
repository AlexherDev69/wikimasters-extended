...
Objectif : afficher le mot "Extended" sous le nom du site, une image sur les cartes que le site laisse sans illustration, un bouton qui ouvre l'article de Wikipédia depuis la carte, un lien Letterboxd pour les films et personnalités du cinéma, les cartes elles-mêmes à la place des noms tronqués sur la page des échanges, la part de chaque rareté dans les cartes que tes paquets révèlent, une vue compacte des grilles de cartes, une partie de Pong quand le site met trop longtemps à charger, et un petit son quand une notification arrive. Elle ne scrolle pas, n'intercepte aucun trafic réseau et n'écrit jamais rien sur le site.
...
### Le mot "Extended" sous le nom du site

Le site écrit son nom en haut de sa propre navigation, "WikiMasters". L'extension ajoute dessous, en petites capitales espacées, le mot "Extended" : c'est ce qui dit d'un coup d'oeil que ce navigateur affiche plus que ce que le site envoie.

C'est la signature de l'extension et non une fonctionnalité de plus : elle n'a pas de case à cocher, elle apparaît partout où le site écrit son nom, et elle disparaît entièrement avec l'extension. Le mot est posé à l'intérieur du lien du site, donc un clic dessus fait exactement ce qu'un clic sur le nom fait, et il est marqué `aria-hidden` : un lecteur d'écran continue d'annoncer le lien du site tel que le site l'a écrit.
...
Chaque carte porte un petit bouton rond marqué d'un "W" dans le coin bas droit, qui ouvre son article de Wikipédia dans un nouvel onglet. Quand la carte porte aussi le logo Letterboxd, le bouton Wikipédia se décale à sa gauche : les deux marques tiennent sur la même ligne, et le coin reste à celle qui l'occupait la première.

L'adresse est construite à partir du titre que la carte affiche déjà : le titre d'une carte EST le titre exact de son article sur la Wikipédia francophone. Mesuré le 2026-09-21 sur les 100 cartes réelles du jeu témoin : 100 titres sur 100 désignent un article existant, sans une seule redirection ni une seule normalisation. Rien n'est donc demandé à personne pour afficher le bouton, ni à Wikipédia ni à Wikidata : il est là dès le premier passage, sur toutes les cartes, y compris celles dont Wikidata ne sait rien.

Jusqu'ici l'article était à une modale de distance, où le site pose son propre lien "Voir l'article sur Wikipédia". Ce lien du site reste évidemment en place : le bouton ne fait que l'avancer d'un clic.

Comme le logo Letterboxd, il empêche son propre clic d'ouvrir en plus la modale de détail de la carte, et il ne contacte Wikipédia qu'au moment où tu cliques toi-même dessus. La lettre est dessinée par l'extension, dans une police à empattements comme celle du logo de l'encyclopédie : rien n'est téléchargé pour l'afficher.
...
L'image est d'abord celle que l'article lui-même met en tête, c'est-à-dire le fichier que le site affiche sur ses propres cartes : elle est demandée dans la requête qui résout déjà les titres, donc elle ne coûte aucun appel de plus. À défaut, elle vient de Wikidata, par les propriétés "image" (P18), "logo" (P154), "affiche" (P3383), "drapeau" (P41), "blason" (P94) et "collage" (P2716), dans cet ordre : la première que possède l'élément est retenue. Cet ordre compte : un élément Wikidata peut porter plusieurs images du même sujet (Danny Strong en a deux, une de 2004 et une de 2013) et la requête en ramène une sans ordre défini, alors que l'image de tête de l'article est celle que le site montre. Elle est demandée avec les autres faits de la carte, dans la requête qui existait déjà : l'extension n'envoie aucune requête supplémentaire. Le fichier lui-même est hébergé par Wikimedia Commons et c'est ton navigateur qui le charge, comme n'importe quelle image d'un article de Wikipédia. Les photos sont cadrées en plein (avec un léger décalage vers le haut, là où se trouvent les visages), les logos, drapeaux et blasons sont affichés en entier sur un fond uni.
...
La carte dessinée porte les deux mêmes marques que les cartes du site : le bouton Wikipédia et, quand la carte a une adresse, le petit logo Letterboxd, dans le coin bas droit de l'image. Chacune suit son propre réglage, donc une marque décochée ailleurs l'est ici aussi.

Un clic sur la carte fait exactement ce qu'un clic sur la pastille faisait, c'est-à-dire ouvrir l'offre. Les deux marques sont les seules exceptions, comme sur une carte du site : cliquer dessus ouvre l'article ou la page Letterboxd sans ouvrir l'offre derrière. Elles sont en revanche invisibles pour un lecteur d'écran et hors du parcours au clavier : l'offre entière est un bouton du site, dont le nom et les arrêts de tabulation doivent rester exactement ceux que le site a prévus, et le même article reste à un clic dans le détail que ce bouton ouvre.
...
La carte compacte garde son image, son badge de rareté, son étoile de favori et son titre, plus les deux marques que l'extension ajoute, le bouton Wikipédia et le logo Letterboxd. Ces deux-là gardent leur taille et leur écart : la bande où ils se tenaient disparaît avec la ligne ATK/DEF, alors ils remontent juste au-dessus du texte, dans le coin bas droit de l'image. Elle laisse de côté la description, les étiquettes et la ligne ATK/DEF : tout cela reste à un clic dans la modale de détail, dont la carte, elle, garde exactement sa taille normale.
...
Quand le compteur de la cloche du site augmente, un petit son de deux notes est joué. C'est la seule fonctionnalité qui ne dessine rien : elle lit le nombre que la cloche affiche déjà, et ne produit qu'un son.

Il ne sonne que pour une notification qui arrive : pas au chargement d'une page qui en affiche déjà, pas quand le compteur redescend parce que tu viens de les lire, et une seule fois quand plusieurs arrivent ensemble. Le navigateur ne joue rien tant que tu n'as pas cliqué au moins une fois sur le site, c'est sa règle et non la nôtre : la première notification après l'ouverture d'un onglet peut donc rester muette.

Rien n'est envoyé nulle part, aucun fichier n'est téléchargé (les deux notes sont fabriquées par le navigateur lui-même), et aucune notification du navigateur ni du système n'est créée.

### Popup de la barre d'outils

Un clic sur l'icône de l'extension ouvre une petite fenêtre : les neuf réglages, chacun avec son interrupteur et la phrase qui dit ce qu'il change. Un clic sur un interrupteur est enregistré aussitôt, un "Enregistré" le confirme en bas, et les onglets du site déjà ouverts suivent sans rechargement.

La fenêtre garde son en-tête et son bouton des options toujours visibles : c'est la liste des réglages qui défile d'elle-même si elle dépasse la hauteur que Chrome accorde à une popup.
...
Section "Fonctionnalités" : neuf cases à cocher, huit activées par défaut et une désactivée par défaut (celle qui masque des statistiques du site, voir plus haut).
...
| Bouton Wikipédia | Le bouton qui ouvre l'article de Wikipédia depuis la carte elle-même, sans passer par la modale de détail |
...
| Son de notification | Le petit son joué quand le compteur de la cloche du site augmente |
...
Les onglets du site déjà ouverts suivent le changement sans rechargement : une fonctionnalité désactivée voit ses éléments retirés tout de suite, et réactivée elle les repose immédiatement. Quand le lien Letterboxd, les images manquantes et les cartes de la page d'échange sont tous désactivés, l'extension n'envoie plus aucune requête de catégorisation : aucun appel ne part vers Wikipédia ni Wikidata. Les six réglages restants n'envoient eux-mêmes jamais la moindre requête, qu'ils soient cochés ou non : le bouton Wikipédia construit son adresse à partir du titre déjà affiché, masquer les statistiques et la vue compacte ne font que peindre la page différemment, les statistiques de tirage comptent une rareté déjà affichée à l'écran, le Pong des chargements se joue entièrement dans un élément de l'extension, et le son de notification lit un nombre déjà affiché par la cloche, le tout sans appel réseau.
...
- Le bouton Wikipédia de la carte ne déclenche lui non plus aucun appel : son adresse est construite à partir du titre que la carte affiche déjà, et Wikipédia n'est atteint qu'au moment où tu cliques toi-même dessus.
...
- Le son de notification n'envoie rien et ne garde rien : il lit le nombre affiché par la cloche du site, le compare à celui de la fois précédente, et les deux notes sont fabriquées par le navigateur au moment où il les joue. Aucun fichier n'est téléchargé et aucune notification du navigateur ni du système n'est créée.
