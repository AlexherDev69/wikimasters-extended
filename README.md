...
Section "Fonctionnalités" : huit cases à cocher, six activées par défaut et deux désactivées par défaut (celle qui masque des statistiques du site et celle qui remplit l'étiquette au clic, voir plus haut).
