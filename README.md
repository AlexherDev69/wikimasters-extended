...
Section "Fonctionnalités" : huit cases à cocher, sept activées par défaut et une désactivée par défaut (celle qui masque des statistiques du site, voir plus haut).
