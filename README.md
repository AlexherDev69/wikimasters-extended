...
Section "Fonctionnalités" : neuf cases à cocher, sept activées par défaut et deux désactivées par défaut (celle qui masque des statistiques du site et celle qui remplit l'étiquette au clic, voir plus haut).
